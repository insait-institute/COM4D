...
# Modified from https://github.com/wgsxm/PartCrafter/blob/main/src/models/attention_processor.py#L428
class COM4DAttnProcessor:
    """
        ...
        if isinstance(num_instances, torch.Tensor):
            ...
            for n_i in num_instances:
                ...
                if k.shape[2] == q.shape[2]:
                    ...
                    # cross-attn: select one set of context tokens per object
                    k = k[::n_i]
                    v = v[::n_i]
